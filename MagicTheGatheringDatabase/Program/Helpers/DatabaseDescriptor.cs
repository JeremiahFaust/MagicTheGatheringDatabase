...
namespace MagicDbContext.Helpers
{
    public class DatabaseDescriptor
    {
        ...
        void InitializeMetadata(ObjectContext ctx)
        {
            ...
            foreach (StructuralType table in tables)
            {
                ...
                var entityType = table as System.Data.Entity.Core.Metadata.Edm.EntityType;
                if (entityType != null)
        ...
        {
            var modified = db.ObjectStateManager.GetObjectStateEntries(System.Data.Entity.EntityState.Added | System.Data.Entity.EntityState.Modified);
